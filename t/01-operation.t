...
like &say.sourcery.join, rx{
    'src/core' [ '.' <[c..z]> ]? '/io_operators.pm6:' $<line>=\d+
    'https://github.com/rakudo/rakudo/blob/'
    <-[/]>+
    '/src/core' [ '.' <[c..z]> ]? '/io_operators.pm6#L' $<line>
}, '&say.sourcery';
...
like Str.^can('say')[0].sourcery.join, rx{
    'src/core' [ '.' <[c..z]> ]? '/Mu.pm6:' $<line>=\d+
    'https://github.com/rakudo/rakudo/blob/'
    <-[/]>+
    '/src/core' [ '.' <[c..z]> ]? '/Mu.pm6#L' $<line>
}, 'Str.say.sourcery';
