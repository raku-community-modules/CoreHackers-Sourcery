...
like &say.sourcery.join, rx{
    'src/core.c/io_operators.pm6:' $<line>=\d+
    'https://github.com/rakudo/rakudo/blob/'
    <-[/]>+
    '/src/core.c/io_operators.pm6#L' $<line>
}, '&say.sourcery';
...
like Str.^can('say')[0].sourcery.join, rx{
    'src/core.c/Mu.pm6:' $<line>=\d+
    'https://github.com/rakudo/rakudo/blob/'
    <-[/]>+
    '/src/core.c/Mu.pm6#L' $<line>
}, 'Str.say.sourcery';
...
like sourcery(42, 'base', \(16)).join, rx{
    'src/core.c/Int.pm6:' $<line>=\d+
    'https://github.com/rakudo/rakudo/blob/'
    <-[/]>+
    '/src/core.c/Int.pm6#L' $<line>
}, 'sourcery 42, "base", \(16)';
